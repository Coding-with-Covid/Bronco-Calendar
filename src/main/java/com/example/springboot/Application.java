...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Add events
		repo.save(new Event("New Club Workshop", "2020-10-08T10:00:00", "Office of Student Life and Cultural Centers", "Zoom", "Club & Organization registration information for students seeking to establish new clubs on campus. No RSVP required. If you arrive late you may not be admitted. Zoom link provided here on the date of the programming."));
		repo.save(new Event("Issa's Eco-Corner", "2020-10-08T11:00:00", "Womxn's Resource Center", "Zoom", "top by and chat with Issa about how to live more \"zero waste\", learn about the environment, DIY fruit fridge masks and more! During Issa's Eco-Corner we will be covering a variety of environmental-related topics, activities, and themes. This week's topic will be \"zero waste kits\" on every budget. Issa will be on Zoom ready to answer any questions you have in order to switch over to more eco-friendly products as well as having a free zero waste kit guide PDF."));
